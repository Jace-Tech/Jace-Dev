...
export const tabMenuItems = {
    ...
    "web": [
        ...
        { title: "Next JS", link: "", img: nextLogo },
        { title: "Express JS", link: "", img: expLogo },
...
export const aboutParagraphs = [
    "Hi, I’m Aneke Chidindu Emmanuel, Software Engineer currently based in Nigeria and I love what I do. In all my years as a Developer I've craved to reconnect with craftsmanship, to make efficent systems.",
    ...
    "I'm thrilled by design and logic; and I solve problems for fun. When I'm not working I'm either playing badminton 🏸, whipping my friends on FIFA 🎮, sharing memes 🤡, doing some art work 🎨 or working out at the gym 🏋🏽‍♂️."
]